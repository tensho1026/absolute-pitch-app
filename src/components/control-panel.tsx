    ...
    <aside className='w-72 bg-gray-900 text-white p-6 shadow-lg'>
      <div className='space-y-8'>
        ...
        <div className='space-y-3'>
          ...
          <Slider
            value={[attack]}
            onValueChange={(value) => onAttackChange(value[0])}
            min={0}
            max={1}
            step={0.01}
          />
        ...
        <div className='space-y-3'>
          ...
          <Slider
            value={[decay]}
            onValueChange={(value) => onDecayChange(value[0])}
            min={0}
            max={1}
            step={0.01}
          />
        ...
        <div className='space-y-3'>
          ...
          <Slider
            value={[sustain]}
            onValueChange={(value) => onSustainChange(value[0])}
            min={0}
            max={1}
            step={0.01}
          />
        ...
        <div className='space-y-3'>
          ...
          <Slider
            value={[release]}
            onValueChange={(value) => onReleaseChange(value[0])}
            min={0}
            max={1}
            step={0.01}
          />
