      ...
      <div className='flex-1 w-full flex items-center justify-center'>
        <div className='relative w-full max-w-3xl'>
          ...
          <div className='w-full h-[120px] relative'>
            ...
            {/* Treble clef */}
            <div className='absolute left-4 top-[-15px] text-[60px] leading-none'>
              𝄞
            </div>

            {/* Time signature */}
            <div className='absolute left-[70px] top-[5px] text-[30px] leading-none'>
              4
            </div>
            <div className='absolute left-[70px] top-[35px] text-[30px] leading-none'>
              4
            </div>
            ...
            <div className='absolute left-[100px] top-0 w-[calc(100%-120px)] flex justify-between'>
              {song.notes.map((note, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-5 h-4 rounded-full bg-black ${
